...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // contra Postgres real (Dia 3, fora de escopo aqui). Um único piso
      // "src/modules/**" misturando as três já obrigou a baixar o número duas
      // vezes (a própria Tarefa 2 já fez isso uma vez) — a cada novo
      ...
      thresholds: {
        ...
        // verdade — por exemplo, um use-case novo do Dia 3 sem nenhum teste
        // (ver o experimento no relatório da Tarefa 2: comentar
        ...
        // Postgres real; virão testes de integração no Dia 3). Os números
        ...
        // tarefa; a meta de verdade é a suíte de integração do Dia 3.
