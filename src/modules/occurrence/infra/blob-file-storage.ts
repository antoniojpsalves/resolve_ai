 ...
 * explicitamente).
 *
 * Não verificado contra o Blob real nesta tarefa — não há como configurar a
 * Vercel neste ambiente (fora de escopo do brief). Fica verificado de
 * verdade no Dia 5, quando o deploy acontecer.
 *
