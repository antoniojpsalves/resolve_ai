 ...
 * revisão posterior). Para o comportamento de produção bater
 * com o de desenvolvimento, o deploy precisa escolher uma das duas: (a) trocar
 ...
 * duas foi implementada aqui — decisão pendente, registrada para o deploy
 * não esquecer.
 */
